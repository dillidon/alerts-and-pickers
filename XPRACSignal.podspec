...
Pod::Spec.new do |s|
  ...
  s.author             = { "Yingdong Wang" => "wangyingdong@data-union.com" }
  # Or just: s.author    = "Yingdong Wang"
  # s.authors            = { "Yingdong Wang" => "wangyingdong@data-union.com" }
  # s.social_media_url   = "http://twitter.com/Yingdong Wang"
